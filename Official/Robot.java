...
public class Robot extends TimedRobot {
  ...
  AHRS accelerometer = new AHRS(Port.kMXP);
  double accelX = 0.0;
  double accelY = 0.0;
  double accelZ = 0.0;
 ...
 //Station (starting position) and cone/cube
  ...
  public void robotInit() {
    ...
    accelThread = new Thread(() -> {
      while(1 != 0) {
        ...
        for(double tempTime = Timer.getFPGATimestamp(); Timer.getFPGATimestamp() - tempTime < 0.00001; tempTime = tempTime) {
  ...
  public void autonomousInit() {
    ...
    goTo(Constants.autoPieceX[station - 1], Constants.autoPieceZ[station - 1], 0);
  ...
  public void teleopPeriodic() {
    ...
    if(Timer.getFPGATimestamp() - autoStart >= 135 && accelerometer.getRawAccelX() == 0 && accelerometer.getRawAccelZ() == 0) {
      balanceOnTeeter(150.0, false, true, false);
    }
